    ...
    <div className={styles.container}>
      <div className={styles.panelWrapper}>
        ...
        <br></br>
          ...
          friends. And so even though we face the difficulties of today and
          ...
          shall see it together."2 This is our hope, and this is the faith that
          I go back to the South with. With this faith, we will be able to hew
          ...
          free one day. And this will be the day -- this will be the day when
          ...
          mountainside, let freedom ring. And when this happens, and when we
