...
import { useParams } from "react-router-dom";
 ...
 const CampaignDetailsDonate = ({getDonorData,getDonorDataComent,getDonorDataDonante ,getDonationStory }) => {
    ...
    useEffect(() => {
      ...
      }, [getDonorData, getDonorDataComent,  idDonate  ,getDonorDataDonante,getDonationStory ]);
